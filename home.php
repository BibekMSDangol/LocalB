...
<div class="home">
   ...
   <section class="center">
      ...
      <form action="search.php" method="post">
         ...
         <div class="flex">
            <div class="box">
               <p>Venue Type: <span>*</span></p>
               <select name="h_type" class="input" required>
                  <option value="flat">Banquet</option>
                  <option value="house">Club</option>
                  <option value="shop">Restaurant</option>
               </select>
            </div>
            <div class="box">
               <p>Offer type: <span>*</span></p>
               <select name="h_offer" class="input" required>
                  <option value="sale">Booking</option>
